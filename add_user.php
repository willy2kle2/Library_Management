<?php include ('header.php'); ?>
                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="email" name="address" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="level" class="select2_single form-control" required="required" tabindex="-1" >
                                            ...
                                            <option value="Senoir Associate">Senoir Associate</option>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4" for="first-name">Unit<span class="required" style="color:red;">*</span>
                                    </label>
                                    <div class="col-md-3">
		...
		//							$profile=$_FILES["image"]["name"];
					...
					$result=mysqli_query($conn, "select * from user WHERE school_number='$school_number' ") or die (mySQLi_error());
					...
					{		
						mysqli_query($conn, "insert into user (school_number,firstname, middlename, lastname, contact, gender, address, type, level, section, status, user_added)
						values ('$school_number','$firstname', '$middlename', '$lastname', '$contact', '$gender', '$address', '$type', '$level', '$section', 'Active', NOW())")or die(mysqli_error($conn));
