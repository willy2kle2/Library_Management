        ...
        <div class="clearfix"></div>
				...
				<a href="admin.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							...
							?>
				<a href="user.php">
                            <span class="count_top"><i class="fa fa-male"></i> <i class="fa fa-female"></i> Staff</span>
				</a>
                            <div class="count green"><?php echo $num_rows; ?></div>
				...
				<a href="book.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                        ...
                        <div class="right">
							<?php
							$result = mysqli_query($conn, "SELECT * FROM borrow_book");
							$num_rows = mysqli_num_rows($result);
							?>
				<a href="borrowed.php">
					...
					<div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                      <div class="left"></div>
                        <div class="right">
							<?php
							$result = mysqli_query($conn, "SELECT * FROM return_book");
							$num_rows = mysqli_num_rows($result);
							?>
