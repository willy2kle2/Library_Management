            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="home.php" class="site_title"><i class="fa fa-university"></i> <span>OAL </span></a>
                    </div>
...
<?php
	...
	$user_query=mysqli_query($conn,"select *  from admin where admin_id='$id_session'")or die(mysql_error());
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li>
									<a href="user.php"><i class="fa fa-users"></i> Staff</a>
                                </li>
                                <li>
