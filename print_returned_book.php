...
<body>
	<div class = "container">
		...
		<br/>
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5> Olisa Abakoba Legal</center>
...
<button type="submit" id="print" onclick="printPage()">Print</button>	
		...
		<br/>
<?php
							$return_query= mysqli_query($conn, "select * from return_book 
							...
							$count_penalty = mysqli_query($conn, "SELECT sum(book_penalty) FROM return_book ")or die(mysqli_error());
