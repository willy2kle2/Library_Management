        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							...
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print Staff List</button>
							</a>
						
							<br />
							<br />
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> Staff Information</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
							<a href="add_user.php" style="background:none;">
							<button class="btn btn-primary btn-outline"><i class="fa fa-plus"></i> Add Staff</button>
							</a>
							</li>
                            <li>
							<a href="import_members.php" style="background:none;">
							<button class="btn btn-success btn-outline"><i class="fa fa-upload"></i> Import Staff</button>
							</a>
							</li>
                        <!---    <li>
