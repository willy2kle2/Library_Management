<?php
			...
			include ('include/dbcon.php');
						$query = mysql_query("SELECT * FROM `barcode` ORDER BY mid_barcode DESC ") or die (mysql_error());
...
<?php include ('header.php'); ?>
        ...
        <div class="row">
			...
			$error = $_FILES["image"] ["error"];
			{
					...
					{
					mysql_query("insert into book (book_title,category_id,author,author_2,author_3,author_4,author_5,book_copies,book_pub,publisher_name,isbn,copyright_year,status,book_barcode,book_image,date_added,remarks)
					values('$book_title','$category_id','$author','$author_2','$author_3','$author_4','$author_5','$book_copies','$book_pub','$publisher_name','$isbn','$copyright_year','$status','$gen','$book_image',NOW(),'$remark')")or die(mysql_error());
					
					mysql_query("insert into barcode (pre_barcode,mid_barcode,suf_barcode) values ('$pre', '$mid', '$suf') ") or die (mysql_error());
					}
